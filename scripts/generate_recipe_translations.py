...
def translate_recipe_content(recipe):
    ...
    translated_description = translate_text(
        recipe["description"], INGREDIENT_TRANSLATIONS
    )
    translated_ingredients = translate_text(
        recipe["ingredients"], INGREDIENT_TRANSLATIONS
    )
    translated_instructions = translate_text(
        recipe["instructions"], INGREDIENT_TRANSLATIONS
    )
