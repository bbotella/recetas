...
def test_flask_application():
    ...
    try:
        ...
        with app.test_client() as client:
            ...
            ), f"Index route failed: {response.status_code}"
            ...
            ), f"Language switch failed: {response.status_code}"
    ...
    try:
        ...
        with app.test_client() as client:
            with app.app_context():
                ...
                assert (
                    response.status_code == 200
                ), f"Spanish route failed: {response.status_code}"
                ...
                assert (
                    response.status_code == 200
                ), f"English route failed: {response.status_code}"
                ...
                assert (
                    response.status_code == 200
                ), f"Chinese route failed: {response.status_code}"
