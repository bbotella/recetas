...
class TestMarkdownIntegration:
    ...
    def test_markdown_processing_integration(self, client):
        ...
        assert (
            b"<p>" in response.data
            or b"<ul>" in response.data
            or b"<ol>" in response.data
        )
...
class TestFullApplicationFlow:
    ...
    def test_concurrent_user_simulation(self, client):
        ...
        users = [
            ...
            {
                "language": "en",
                "search": "Test Recipe 1 EN",
                "expected": "Test Recipe 1 EN",
            },
            {
                "language": "zh",
                "search": "Test Recipe 1 ZH",
                "expected": "Test Recipe 1 ZH",
            },
        ]
...
class TestSecurityIntegration:
    ...
    def test_sql_injection_protection_integration(self, client):
        ...
        for query in malicious_queries:
            ...
            assert (
                b"Test Recipe 1" not in response.data
                or b"Test Recipe 1" in response.data
            )
