    ...
    if language != 'es':
        ...
        if translation:
            ...
            recipe_dict.update({
                ...
                'instructions': translation['instructions'] or recipe['instructions'],
...
def save_recipe_translation(recipe_id, language, title=None, description=None, ingredients=None, instructions=None, category=None):
    ...
    if existing:
        ...
        conn.execute('''
            ...
            WHERE recipe_id = ? AND language = ?
        ''', [title, description, ingredients, instructions, category, recipe_id, language])
    else:
