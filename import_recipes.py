...
def parse_markdown_recipe(file_path):
    ...
    ingredients_match = re.search(r'## Ingredientes\s*\n(.+?)(?=\n## Preparación|\n---|\Z)', content, re.DOTALL)
...
def categorize_recipe(title, description, ingredients):
    ...
    categories = {
        'Postres': ['tarta', 'flan', 'helado', 'bizcocho', 'chocolate', 'crema', 'moka', 'galleta', 'mousse', 'puding'],
        'Bebidas': ['batido', 'coco', 'limón', 'naranja', 'plátano'],
        'Pollo': ['pollo', 'pularda'],
        'Pescado': ['pescado', 'merluza', 'lenguado', 'arenque', 'rosada', 'bacalao', 'calamares'],
        'Carnes': ['cordero', 'lomo', 'ternera', 'faisán', 'liebre', 'jamón'],
        'Verduras': ['espinacas', 'alcachofas', 'guisantes', 'cebolla', 'patata', 'espárragos'],
