...
def load_json_translations(language_code):
    ...
    file_path = f"/Users/bernardobotellacorbi/Documents/dev/tiaCarmen/translations_{language_code}.json"
    ...
    for lang_name, lang_code in language_mappings.items():
        ...
        for recipe_id_str, translation in translations.items():
            ...
            try:
                ...
                print(f"Error inserting translation for recipe {recipe_id} in {lang_name}: {e}")
